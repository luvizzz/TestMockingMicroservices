...
public abstract class BaseController {
    ...
    protected static final ErrorMessage PLEASE_ID_PROVIDED_IN_BODY_MSG = new ErrorMessage(BAD_REQUEST, "Please do not provide lease id in body");
    protected static final ErrorMessage PAYMENT_ID_PROVIDED_IN_BODY_MSG = new ErrorMessage(BAD_REQUEST, "Please do not provide lease id in body");
    ...
    protected static final ErrorMessage PAYMENT_NOT_ACCEPTED_MSG = new ErrorMessage(BAD_REQUEST, "Please do not provide payments during lease creation");
    protected static final ErrorMessage PAYMENT_CUSTOMER_MISMATCH_MSG = new ErrorMessage(BAD_REQUEST, "This paymentId does not refer to this customer");
    protected static final ErrorMessage PAYMENT_LEASE_MISMATCH_MSG = new ErrorMessage(BAD_REQUEST, "This paymentId does not refer to this lease");
